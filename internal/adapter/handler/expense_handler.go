...
func (h *ExpenseHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		response.Error(w, http.StatusInternalServerError, "failed to create expense", err.Error())
		return
	}
...
func (h *ExpenseHandler) List(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		response.Error(w, http.StatusInternalServerError, "failed to list expenses", err.Error())
		return
	}
...
func (h *ExpenseHandler) Get(w http.ResponseWriter, r *http.Request) {
	...
	if strings.TrimSpace(uuid) == "" {
		response.Error(w, http.StatusBadRequest, "invalid expense uuid", nil)
		return
	}
	...
	if err != nil {
		if err.Error() == "expense not found" {
			response.Error(w, http.StatusNotFound, "expense not found", nil)
			return
		}
		response.Error(w, http.StatusInternalServerError, "failed to get expense", err.Error())
		return
	}
...
func (h *ExpenseHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		response.Error(w, http.StatusInternalServerError, "failed to update expense", err.Error())
		return
	}
...
func (h *ExpenseHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.svc.DeleteExpense(r.Context(), userID, uuid); err != nil {
		...
		response.Error(w, http.StatusInternalServerError, "failed to delete expense", err.Error())
		return
	}
